    ...
    const groups: CategoryGroup[] = [
      {
        ...
        items: [
          { id: "1", name: "Latte", description: "", categoryName: "Coffee", imageUrl: null, variations: [] },
          { id: "2", name: "Mocha", description: "", categoryName: "Coffee", imageUrl: null, variations: [] },
        ],
      },
      {
        category: { id: "cat2", name: "Tea" },
        items: [
          { id: "3", name: "Green", description: "", categoryName: "Tea", imageUrl: null, variations: [] },
        ],
      },
    ];
